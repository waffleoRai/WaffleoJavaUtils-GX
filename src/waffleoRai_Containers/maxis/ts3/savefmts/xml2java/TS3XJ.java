...
public class TS3XJ {
	...
	public static final String[] DEF_TYPES = {"Struct", "PropertyStreamStruct", "DataStruct"};
	...
	public static DataField parseXmlNode(Element element) {
		...
		else if(nodeName.equals("PSField") || nodeName.equals("StructField") || nodeName.equals("DataField")) {
			String rawType = element.getAttribute("Type");
			if((rawType != null) && !rawType.isEmpty()) {
				if(rawType.startsWith("Struct:")) {
					StructField fdef = new StructField();
	...
	private static void writeInnerStructsBody(BufferedWriter out, List<DataField> children, String templatePath, String indent) throws IOException {
		List<DataField> anonStructs = new LinkedList<DataField>();
		for(DataField child : children) {
	...
	public static void writeClassTo(Element defNode, AnonStructField altInput, BufferedWriter bw, String templatePath, boolean inner) throws IOException {
		String defName = null;
