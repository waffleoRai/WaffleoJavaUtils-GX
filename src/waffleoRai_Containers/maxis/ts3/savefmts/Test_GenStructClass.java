...
import waffleoRai_Containers.maxis.ts3.savefmts.xml2java.TS3XJ;
import waffleoRai_Files.XMLReader;
import waffleoRai_Utils.StringUtils;

public class Test_GenStructClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(defList.isEmpty()) {
				System.err.println("Failed to find any struct/PS def nodes!");
				System.exit(1);
			}
			...
			for(Element e : defList) {
				...
				TS3XJ.writeClassTo(e, null, bw, templateFile, false);
