...
public class MaterialRecordDataType {
//Game Script: 
//Enum type: s32

	public static final int D_Float = 1;
	public static final int D_Int = 2;
	public static final int D_Texture = 3;
