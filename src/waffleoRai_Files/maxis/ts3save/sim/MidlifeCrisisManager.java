...
//TS3 Script: Sims3.Gameplay.ActorSystems.MidlifeCrisisManager
	...
	protected boolean readPropertyStream_internal(MaxisPropertyStream stream) {
		...
		mNumberBreakups = stream.getFieldAsInt(PSID_MNUMBERBREAKUPS, false);
		mNumberDivorces = stream.getFieldAsInt(PSID_MNUMBERDIVORCES, false);
		mFamilyMembersDied = stream.getFieldAsInt(PSID_MFAMILYMEMBERSDIED, false);
	...
	public void addToPropertyStream(MaxisPropertyStream ps) {	
		...
		ps.addInt(mNumberBreakups, PSID_MNUMBERBREAKUPS, false);
		ps.addInt(mNumberDivorces, PSID_MNUMBERDIVORCES, false);
		ps.addInt(mFamilyMembersDied, PSID_MFAMILYMEMBERSDIED, false);
	}
