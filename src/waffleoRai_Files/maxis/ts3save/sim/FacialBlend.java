...
public class FacialBlend {
	...
	public static FacialBlend readFromPropertyStream(MaxisPropertyStream ps, int baseId) {
		...
		str.key.setGroupId(ps.getFieldAsInt(baseId, false));
		str.key.setTypeId(ps.getFieldAsInt(baseId+1, false));
		str.key.setInstanceId(ps.getFieldAsLong(baseId+2, false));
	...
	public void writeToPropertyStream(MaxisPropertyStream ps, int baseId) {
		...
		ps.addInt(key.getGroupId(), baseId, false);
		ps.addInt(key.getTypeId(), baseId+1, false);
		ps.addLong(key.getInstanceId(), baseId+2, false);
