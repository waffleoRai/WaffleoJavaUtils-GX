...
//TS3 Script: Sims3.Gameplay.Skills.SkillManager
	...
	protected boolean readPropertyStream_internal(MaxisPropertyStream stream) {
		...
		mSkillModifiersKeys = stream.getFieldAsShortArray(PSID_MSKILLMODIFIERSKEYS, false);
	...
	public void writeXMLNode(Writer out, String indent, String varName) throws IOException {
		...
		out.write(indent + "\t</List>\n");
		if(mRobotLearnedSkills != null) mRobotLearnedSkills.writeXMLNode(out, indent + "\t", XMLKEY_MROBOTLEARNEDSKILLS);
		
		if(mSkillModifiersKeys != null) {
	...
	public void addToPropertyStream(MaxisPropertyStream ps) {	
		...
		ps.addShortArray(mSkillModifiersKeys, PSID_MSKILLMODIFIERSKEYS, false);
