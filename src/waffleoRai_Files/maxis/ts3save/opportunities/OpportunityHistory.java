...
//TS3 Script: Sims3.Gameplay.Opportunities.OpportunityHistory
	...
	protected boolean readPropertyStream_internal(MaxisPropertyStream stream) {
		...
		mCompletedOpportunitiesCount = stream.getFieldAsInt(PSID_MCOMPLETEDOPPORTUNITIESCOUNT, true);
		mCompletedOpportunitiesKeys = stream.getFieldAsLongArray(PSID_MCOMPLETEDOPPORTUNITIESKEYS, false);
		mLastOpportunities = stream.getFieldAsLongArray(PSID_MLASTOPPORTUNITIES, false);
	...
	public void addToPropertyStream(MaxisPropertyStream ps) {	
		...
		mCompletedOpportunitiesCount = mCompletedOpportunitiesKeys.length;
		ps.addInt(mCompletedOpportunitiesCount, PSID_MCOMPLETEDOPPORTUNITIESCOUNT, true);
		ps.addLongArray(mCompletedOpportunitiesKeys, PSID_MCOMPLETEDOPPORTUNITIESKEYS, false);
		ps.addLongArray(mLastOpportunities, PSID_MLASTOPPORTUNITIES, false);
