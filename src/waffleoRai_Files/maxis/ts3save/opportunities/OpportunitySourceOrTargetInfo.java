...
//TS3 Script: Sims3.Gameplay.Opportunities.Opportunity
	...
	protected boolean readPropertyStream_internal(MaxisPropertyStream stream) {
		...
		worldId = stream.getFieldAsInt(PSID_WORLDID, true);
		objectId = stream.getFieldAsLong(PSID_OBJECTID, false);
	...
	public void addToPropertyStream(MaxisPropertyStream ps) {	
		if(ps == null) return;
		ps.addInt(worldId, PSID_WORLDID, true);
		ps.addLong(objectId, PSID_OBJECTID, false);
	}
